...
restricted permutation tests.Some insight in the premutation technique is required to use this package. The Floating Grid Permutation Technique is introduced in Radersma and Sheldon (2015). The next paragraphs will give a short overview of the method.
